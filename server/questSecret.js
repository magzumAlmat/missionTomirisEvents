/**
 * СЕКРЕТЫ КВЕСТА — ответы, буквы, подсказки и финальный код.
 *
 ...
 * финальный код и место, где спрятан приз. Этот файл читает ТОЛЬКО сервер:
 * участник присылает ответ, сервер сверяет и отдаёт букву.
 *
...
export const FINAL_CODE = "ПРИЗ2026";

export const FINAL_WIN =
  "Поздравляем! Финальная точка — фонтан на Центральной площади. " +
  "Загляни под левую скамейку — там тебя ждёт приз. 🎉";
