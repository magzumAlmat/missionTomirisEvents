...
export default function Landing() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "На каждой точке вы сканируете QR-код, разгадываете загадку и вводите ответ. Организаторы видят ваш прогресс в реальном времени. Команда, первой прошедшая все восемь точек, получает суперприз!",
    },
  ];
        ...
        <div className="features-list">
          ...
          <div className="feature-item">
            ...
            <div>
              ...
              <p className="muted">
                Каждая отгаданная точка даёт секретную букву. Пройдите все восемь и заберите реальный приз!
              </p>
            </div>
          </div>
        </div>
