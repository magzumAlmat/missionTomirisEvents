...
export default function Landing() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Необязательно! Квест можно проходить как на автомобиле, так и пешком или на электросамокатах/велосипедах. В форме регистрации укажите, будете ли вы на авто.",
    },
    {
    ...
    },
    {
      ...
      a: "На каждой точке вы сканируете QR-код, разгадываете загадку и нажимаете кнопку отправки. Организаторы видят ваш прогресс в реальном времени. Первые, кто соберёт финальный код, получат суперприз!",
    },
  ];
        ...
        <div className="features-list">
          ...
          <div className="feature-item">
            ...
            <div>
              ...
              <p className="muted">
                Каждая отгаданная точка даёт секретную букву. Сложите финальный пароль и найдите реальный приз в городе!
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="steps-container">
          ...
          <div className="step-card">
            ...
            <div className="step-content">
              ...
              <p className="muted">Нажмите «Я прибыл» и «Я отгадал», чтобы получить букву и подсказку к следующей точке.</p>
            </div>
          </div>
          ...
          <div className="step-card">
            ...
            <div className="step-content">
              <h3>Заберите приз!</h3>
              <p className="muted">Соберите все 8 букв, введите финальный код и получите заветный награду.</p>
            </div>
          </div>
        </div>
      </div>
